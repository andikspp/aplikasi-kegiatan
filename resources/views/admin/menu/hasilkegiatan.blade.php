...
<div class="container-fluid">
    <div class="d-flex mb-4">
        ...
        <button class="btn btn-link">Kelola Peserta</button>
        <button class="btn btn-link">Kelola Lainnya</button>
    </div>
    ...
    <form id="formUbahKegiatan">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="namaKegiatan" name="namaKegiatan" value="Rapat Koordinasi Pengelolaan Kinerja Guru dan Kepala Sekolah Bagi PIC Dinas Pendidikan Region 1">
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <input type="datetime-local" class="form-control" id="tanggalMulai" name="tanggalMulai" value="2024-07-10T12:00">
            </div>
            <div class="col-sm-5">
                <label for="tanggalSelesai">Selesai</label>
                <input type="datetime-local" class="form-control" id="tanggalSelesai" name="tanggalSelesai" value="2024-10-18T12:00">
            </div>
        </div>

        <div class="mb-3">
            <label for="tanggalKegiatan" class="form-label">Tanggal Kegiatan</label>
            <input type="text" class="form-control" id="tanggalKegiatan" name="tanggalKegiatan" value="16 s.d. 18 Oktober 2024">
        </div>

        <!-- Tambahan baru di bawah Tanggal Kegiatan -->
        <div class="mb-3">
            <label for="tempatKegiatan" class="form-label">Tempat Kegiatan</label>
            <input type="text" class="form-control" id="tempatKegiatan" name="tempatKegiatan" value="Surabaya, Jawa Timur">
        </div>
