                ...
                <div class="card shadow-lg">
                    ...
                    @if ($kegiatan->link_meeting)
                        <div class="duration-box mb-3">
                            ...
                            <a href="{{ $kegiatan->link_meeting }}" target="_blank"
                                class="d-block text-center text-truncate"
                                style="
                        color: #4338ca; 
                    ...
                    <div class="text-center mt-4">
                        ...
                        @if ($now < $pendaftaranMulai)
                            <div class="alert" style="background: #fff3cd; border: none; border-radius: 12px;"
                                role="alert">
                        ...
                        @else
                            <a href="{{ route('kegiatan.daftar', $kegiatan->id) }}" class="daftar-btn"
                                style="margin-bottom: 20px;"> Daftar </a>
                        @endif
                    </div>
                </div>
            </div>
...
@section('styles')
    <style>
        ...
        .daftar-btn {
            ...
            text-decoration: none;
            margin-top: -50px;
            /* Tambahkan ini untuk membuat tombol sedikit ke atas */
        }
