...
class KegiatanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'membutuhkan_mapel' => 'nullable|in:ya,tidak',
            'membutuhkan_nomor_rekening' => 'required|in:ya,tidak',
            'membutuhkan_lokasi' => 'nullable|in:ya,tidak',
            'membutuhkan_foto_presensi' => 'nullable|in:ya,tidak',
            'menggunakan_sertifikat' => 'nullable|in:ya,tidak',
